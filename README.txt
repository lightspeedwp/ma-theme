...
{{theme_name}} is a modern, full-site editing (block) theme designed for {{target_audience}}. Built with performance, accessibility, and customization in mind, this theme leverages the latest WordPress block editor features to provide a flexible and user-friendly experience.
...
Yes! {{theme_name}} is built as a block theme with full FSE support.
...
{{theme_name}} Theme, (C) {{year}} {{author}}
{{theme_name}} is distributed under the terms of the {{license}}.

=== Images ===

[If your theme includes images, list them here with their licenses]

Screenshot image: Created by {{author}}, licensed under {{license}}
