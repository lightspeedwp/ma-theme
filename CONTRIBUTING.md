...
Before creating bug reports, please check the [existing issues](https://github.com/LightSpeed/ma-theme/issues) to see if the problem has already been reported. If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/LightSpeed/ma-theme/issues/new).
...
Enhancement suggestions are welcome! Please [open an issue](https://github.com/LightSpeed/ma-theme/issues/new) with:
...
Feel free to [open an issue](https://github.com/LightSpeed/ma-theme/issues/new) or contact the maintainers if you have any questions about contributing.
