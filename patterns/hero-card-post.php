<?php
/**
 * Title: Hero Card — Post
 * Slug: ma-theme/hero-card-post
 * Description: Horizontal hero card for posts with square image, post-type label, journal logo, title, and date.
 * Categories: 
 * Keywords: hero, card, post, featured, horizontal
 * Viewport Width: 520
 * Inserter: true
 *
...
$type_label = esc_html__( 'Latest Article', 'ma-theme' );
$logo_url   = get_template_directory_uri() . '/assets/logos/journal-placeholder.svg';
$logo_alt   = esc_attr__( 'Journal logo', 'ma-theme' );
?>
<!-- wp:group {"tagName":"article","metadata":{"name":"Hero Card — Post"},"className":"is-style-card-hero","style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
