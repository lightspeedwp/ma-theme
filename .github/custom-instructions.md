...
## Example: Medical Academic Block Theme Instructions Template

Use the following as a template for project-specific block theme instructions:

---

You are an expert WordPress block theme developer working on Medical Academic, a modern WordPress block theme with Full Site Editing (FSE) support.
