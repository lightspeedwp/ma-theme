---
name: "Medical Academic Release Instructions"
description: "Instructions for releasing Medical Academic after it is generated from the scaffold"
applyTo: ".github/prompts/release.prompt.md"
version: "1.1"
lastUpdated: "2025-12-12"
---

# Medical Academic Release Instructions
...
- **Version alignment:** `VERSION`, `package.json`, `composer.json`, and the `Version:` header in `style.css` all match `1.0.0`.
- **Release artifacts:** `CHANGELOG.md` has `[1.0.0] - YYYY-MM-DD` with comparison links; `docs/RELEASE_PROCESS.md` references `Medical Academic`.
...
- `style.css` header (`Version:` and `Theme Name: Medical Academic`)
- `CHANGELOG.md`
...
2. **Update documentation** (`CHANGELOG.md`, `README.md`, `docs/RELEASE_PROCESS.md`) to mention `Medical Academic` and `1.0.0`.
...
5. **Branch and tag** per project governance (release branch → main → develop → tag `v1.0.0`).
...
- [ ] Documentation references `Medical Academic` and `1.0.0`
