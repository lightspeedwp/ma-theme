...
This guide covers the complete release process for **Medical Academic**, following semantic versioning and the governance standards defined in [GOVERNANCE.md](GOVERNANCE.md).

> **Note:** This file contains `{{mustache}}` placeholders that are replaced when the theme is generated from the scaffold. If you see unreplaced placeholders like `Medical Academic`, this indicates a generation issue.
...
[Unreleased]: https://github.com/LightSpeed/ma-theme/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/LightSpeed/ma-theme/releases/tag/v1.0.0
```
...
1. Go to `https://github.com/LightSpeed/ma-theme/releases/new`
2. Select tag: `v1.0.0`
3. Title: `v1.0.0`
...
- [ ] Tag visible on GitHub: `https://github.com/LightSpeed/ma-theme/releases`
