...
- **Flexible**: Supports basic transformations (e.g., `MA_THEME`)
...
| `Medical Academic` | text | Human-readable theme display name | `Tour Starter Theme` | style.css, theme.json, PHP, JS |
| `{{namespace}}` | slug | PHP namespace (underscored theme_slug) | `tour_starter` | functions.php, PHP files |
| `A block based these for the MA society` | text | One or two sentence theme description | `A modern WordPress block theme for tour operators` | style.css, README.txt, package.json |

#### Author & Contact Variables

| Variable | Type | Description | Example | Used In |
|----------|------|-------------|---------|---------|
| `LightSpeed` | text | Theme author name | `LightSpeed` | style.css, package.json, README.txt |
...
| `6.9` | version | Tested up to WordPress version | `6.7` | style.css, README.txt |
| `8.0` | version | Minimum PHP version required | `8.0` | style.css, composer.json |
| `2026` | number | Copyright year | `2025` | style.css, LICENSE |
...
| `https://github.com/LightSpeed/ma-theme` | url | GitHub/Git repository URL | `https://github.com/user/theme` | package.json, docs |
| `https://github.com/LightSpeed/ma-theme/wiki` | url | Documentation website | `https://github.com/user/theme/wiki` | README.txt, SUPPORT.md |
| `https://wordpress.org/support/theme/ma-theme` | url | Support forum URL | `https://wordpress.org/support/theme/slug` | README.txt |
| `https://github.com/LightSpeed/ma-theme` | url | Changelog URL | `https://github.com/user/theme/releases` | package.json |
...
| `720px` | number | Content width in pixels (no unit) | `720` | functions.php |
...
| `55` | number | Default excerpt word count | `55` | functions.php |
...
| Variable | Type | Description | Example | Used In |
|----------|------|-------------|---------|---------|
| `1200` | number | Featured image width in pixels | `1200` | functions.php |
| `630` | number | Featured image height in pixels | `675` | functions.php |
| `150` | number | Thumbnail width in pixels | `300` | functions.php |
| `150` | number | Thumbnail height in pixels | `300` | functions.php |
| `800` | number | Gallery image width in pixels | `800` | functions.php |
| `600` | number | Gallery image height in pixels | `600` | functions.php |
...
```css
/*
Theme Name: Medical Academic
Theme URI: https://example.com/theme
Author: LightSpeed
Author URI: https://lightspeedwp.agency
Description: A block based these for the MA society
Version: 1.0.0
...
```json
{
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/LightSpeed/ma-theme"
  }
}
```
...
- All placeholders like `ma-theme`, `Medical Academic`, etc., will be replaced with your values.
